...
12. **Sentence pattern slop**: "It's not X, it's Y" constructions, verb inflation ("serves as", "stands as", "represents", "marks" instead of "is"), uniform sentence length, opening by restating the question, closing with an upbeat summary paragraph. Read aloud - if it sounds like a press release, rewrite it.
